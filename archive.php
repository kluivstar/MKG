<?php
/**
 * MK GLAMZ archive.php post lists and categories template
 */
...
<main class="py-section-desktop max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop min-h-screen">
  <div class="mb-16">
    ...
    <div class="text-on-surface-variant font-body-lg max-w-xl">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
    ...
    if ( have_posts() ) :
        ...
        echo '<p class="text-on-surface-variant">No items found.</p>';
    endif;
    ?>
  </div>
</main>
