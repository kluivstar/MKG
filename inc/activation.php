...
if ( ! function_exists( 'mk_glamz_admin_menu' ) ) {
...
if ( ! function_exists( 'mk_glamz_after_switch_theme' ) ) {
...
// 3. Admin Notice
if ( ! function_exists( 'mk_glamz_admin_notices' ) ) {
...
// Global Helpers for Elementor Containers & Widgets
if ( ! function_exists( 'mk_glamz_el_container' ) ) {
...
if ( ! function_exists( 'mk_glamz_el_widget' ) ) {
...
// Global Helper for Page Creation
...
// Global Helper for Navigation Menu Assignment
if ( ! function_exists( 'mk_glamz_setup_menu' ) ) {
...
// 4. Main Installer Action Routine
if ( ! function_exists( 'mk_glamz_run_setup_routine' ) ) {
    function mk_glamz_run_setup_routine() {
        ...
        // Complete Home Page Elementor Data
...
if ( ! function_exists( 'mk_glamz_reset_starter_content' ) ) {
...
if ( ! function_exists( 'mk_glamz_setup_page_callback' ) ) {
